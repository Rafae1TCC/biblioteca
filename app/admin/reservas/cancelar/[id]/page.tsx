...
import { CancelarReservaForm } from "@/components/admin/cancelar-reserva-form"

export default async function CancelarReservaPage({ params }: { params: { id: string } }) {
      ...
      <div className="flex flex-1 flex-col md:flex-row">
        ...
        <main id="contenido-principal" className="flex-1 p-4 md:p-6 lg:p-8">
          <div className="flex flex-col gap-6">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Cancelar Reserva</h1>
              <p className="text-muted-foreground">
                Cancela esta reserva y devuelve el libro al inventario disponible.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <CancelarReservaForm reserva={reserva} />
              </div>
            </div>
          </div>
        </main>
